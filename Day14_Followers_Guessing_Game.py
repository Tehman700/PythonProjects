...
def checking(first, second):
    ...
    while True:
        ...
        option = input("Which has more Followers. Type 'A' or 'B': ")
...
# Initialize first and second random choices
frp = random.choice(data)
srp = random.choice(data)

# Ensure that the initial two choices are not the same
while srp == frp:
    srp = random.choice(data)
